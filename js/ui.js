...
export class UIManager {
    ...
    addToBlockchain() {
        try {
            ...
            // Import Block class dynamically
            import('./blockchain.js').then(({ Block }) => {
    ...
    initializeSampleData(sampleData) {
        ...
        sampleData.forEach((data, index) => {
            setTimeout(() => {
                ...
                const block = new window.Block(this.blockchain.chain.length, data, "");
...
export class AIUpdateManager {
    ...
    async generateAIUpdate() {
        try {
            const aiRecord = this.sampleDataGenerator.generateAIRecord();
            // Use the globally available Block class
            const newBlock = new window.Block(this.blockchain.chain.length, aiRecord, "");
            this.blockchain.addBlock(newBlock);
